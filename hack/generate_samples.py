...
REQUIRED_FIELDS = {
    ...
    'PersistentVolumeRebinding': ['spec.rebindings.template', 'spec.rebindings.template.sourceClaim.dbaasDatabaseArchive', 'spec.rebindings.template.targetClaim.dbaasDatabaseArchive']
}
